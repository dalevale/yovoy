...
<body>
    ...
    <div class= "friends">
        <div id="searchUser" class="tarjeta_gris">
            <input class="searchUser" type="text" name="search" required placeholder="Nombre usuario">
            <input id="searchEventBtn" type='image' title="Buscar" alt="submit" width="20%" length="20%" src='includes/img/boton_BUSCAR.png'>
        </div>
        <div id="userActivity" class="tarjeta_gris">
